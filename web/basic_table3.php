        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="registeradmin.php">Registration</a></li>
                    </ul>
                </li>
            </ul>            </div>
        <!-- sidebar menu end-->
...
$sql = mysqli_query($conn, "select * from barang") or die (mysqli_error($conn));
   // mengulangi data agar tidak hanya 1 yang tampil
   while($data = mysqli_fetch_array($sql)) {

   ?>
   <tr data-expanded="true">
    <td><?php echo $data['luasTanah'] ?></td>
    <td><?php echo $data['lokasi'] ?></td>
    <td><?php echo $data['harga'] ?></td>
    <td><?php echo $data['tangalUpdate'] ?></td>
    <td><?php echo $data['Status'] ?></td>
    <td><?php echo $data['user_id'] ?></td>
    <!--Hanya pemanis tampilan-->
    <td >
    <button><a href='form_component.php?idbarang=<?php echo $data["idbarang"] ?>'>Ubah</a></button>
    <button><a href='Hapus.php?idbarang=<?php echo $data["idbarang"] ?>'>Hapus</a></button>
    </tr>
    </td>
   </tr>
  <?php 

...
if(isset($_POST['btn-submit']))
{
	...
	$stmt = $user->runQuery("SELECT id FROM user WHERE userEmail=:email LIMIT 1");
	...
	if($stmt->rowCount() == 1)
	{
		...
		$message= "
				   ...
				   <br /><br />
				   <a href='http://e-tan.khaff.com/resetpass.php?id=$id&code=$code'>click here to reset your password</a>
				   <br /><br />
				   thank you :)
				   ";

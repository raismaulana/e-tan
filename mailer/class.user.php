...
{	
	...
	public function register($uname,$email,$upass,$code,$nama,$alamat,$notelp,$tempatlahir,$tanggallahir,$fkktp,$gender,$kk,$npwp,$suratnikah)
	{
		try
		{							
			$password = md5($upass);
			$stmt = $this->conn->prepare("INSERT INTO user(userName,userEmail,userPass,tokenCode,nama,alamat,noTelp,tempatLahir,tanggalLahir,fotoKopiKTP,jenisKelamin,kk,NPWP,suratNikah) 
			                                             VALUES(:user_name, :user_mail, :user_pass, :active_code, :nama_user, :alamat_user, :nomor_telepon, :tempat_lahir, :tanggal_lahir, :fotokopi_ktp, :jenis_kelamin, :kartu_keluarga, :npwpajak, :surat_nikah)");
